     ...
     List<WebElement> prices=driver.findElements(By.xpath("//div[@class='inventory_item_price']"));
		...
		int PL=prices.size();
		 ...
		 for(int i=0;i<PL;i++) {
			...
			double pvalue = Double.parseDouble(pl.replace("$", ""));
			System.out.println(pvalue);
			Thread.sleep(3000);

			if(pvalue>10.00) {
				Thread.sleep(3000);
//                  WebElement button=prices.get(i);
//                  js.executeScript("arguments[0].click()", button);
				
				WebElement addtocart=l.findElement(By.xpath("./ancestor::div[@class='inventory_item']//button"));
...
//		Thread.sleep(3000);
		...
		File src=ts.getScreenshotAs(OutputType.FILE);
		 String dest=  System.getProperty("user.dir")+"//ScreenShotsSL//"+"sl3.png";
